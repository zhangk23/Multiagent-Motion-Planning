...
agents = [A2,A3,A5,A7,A9,A12,A14,A15,A18,A20];
...
goal2 = plot(A2.rg(1),A2.rg(2),'rs');
goal3 = plot(A3.rg(1),A3.rg(2),'gs');
goal5 = plot(A5.rg(1),A5.rg(2),'bs');
goal7 = plot(A7.rg(1),A7.rg(2),'ys');
goal9 = plot(A9.rg(1),A9.rg(2),'cs');
goal12 = plot(A12.rg(1),A12.rg(2),'ms');
goal14 = plot(A14.rg(1),A14.rg(2),'s','Color',colors(9,:));
goal15 = plot(A15.rg(1),A15.rg(2),'s','Color',colors(10,:));
goal18 = plot(A18.rg(1),A18.rg(2),'s','Color',colors(13,:));
goal20 = plot(A20.rg(1),A20.rg(2),'s','Color',colors(15,:));
...
% legend([goal2 goal3 goal5 goal7 goal9 goal12 goal14 goal15 goal18 goal20],{'(-4,2)','(-4,0)','(-4,-4)','(-2,2)','(-2,-2)','(0,2)','(0,-2)','(0,-4)','(2,0)','(2,-4)'},'AutoUpdate','off');

% plot start positions of agents
plot(A2.r(1), A2.r(2),'ro')
plot(A3.r(1), A3.r(2),'go')
plot(A5.r(1), A5.r(2),'bo')
plot(A7.r(1),A7.r(2),'yo')
plot(A9.r(1),A9.r(2),'co')
plot(A12.r(1),A12.r(2),'mo')
...
vidfile = VideoWriter('10_Obs.mp4','MPEG-4');
open(vidfile);
count_agent_11 = 0;
count_agent_21 = 0;
count_agent_31 = 0;
